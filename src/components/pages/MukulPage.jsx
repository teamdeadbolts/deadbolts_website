...
const MukulPage = () => (
    <div className="profile-page-container">
        ...
        <p className="profile-description">
            As Mechanical Co-Captain of the Deadbolts, Mukul helps lead the design and fabrication of the team’s robot. Known for his precision and collaborative spirit, he plays a key role in turning creative ideas into reliable systems on the field.
        </p>
