  ...
  return (
    <>
      <div className="carousel-wrapper">
        ...
        >
          <CarouselItem
            background="/images/alliancePhoto.webp"
            ...
            robotImage="/images/IMG_5927.webp"
            robotAlt="2024 Robot"
          />
          <CarouselItem
            background="/images/2023alliancephoto.webp"
            gameImage="/images/Charged_Up_Log.webp"
            alt="Alliance Photo"
            year="2023"
            ...
            robotImage="/images/vision-systems.webp"
            robotAlt="2023 Robot"
          />
          <CarouselItem
            background="/images/2022alliance.webp"
            ...
            robotImage="/images/2022robot.webp"
            robotAlt="2022 Robot"
          />
          <CarouselItem
            background="/images/covid.webp"
            gameImage="/images/infiniterecharge.webp"
            alt="Alliance Photo"
            year="2021/2020"
            robotName="Das Boot"
            ...
            robotImage="/images/dasboot.webp"
            robotAlt="2021/2020 Robot"
          />
          <CarouselItem
            background="/images/moonplangoog.webp"
            gameImage="/images/bettedeepspace.webp"
            alt="Alliance Photo"
            year="2019"
            ...
            robotImage="/images/vision-systemsnotnotnot.webp"
            robotAlt="No Image :("
          />
          <CarouselItem
            background="/images/retrogramelevl.webp"
            gameImage="/images/powerupfrc.webp"
            alt="Alliance Photo"
            year="2018"
            ...
            robotImage="/images/2018robot.webp"
            robotAlt="2018 Robot"
          />
          <CarouselItem
            background="/images/evenbettershoppingcart.webp"
            gameImage="/images/steamworksfrc.webp"
            alt="Alliance Photo"
            year="2017"
            ...
            robotImage="/images/2017robot.webp"
            robotAlt="2017 Robot"
          />
          <CarouselItem
            background="/images/strongholdgam.webp"
            gameImage="/images/first-stronghold-logo-color-nb.webp"
            alt="Alliance Photo"
            year="2016"
            robotName="Atlas"
            description="Our 2016 robot, Atlas was designed to shoot balls, navigate the terrain, and play defense."
            robotImage="/images/2016robot.webp"
            robotAlt="2016 Robot"
          />
        </Carousel>
      </div>
