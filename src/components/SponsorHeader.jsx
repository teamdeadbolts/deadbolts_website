...
return (
    <div className="sponsor-header">
        <div className="sponsor-text">
            ...
            <p>
                We're Team Deadbolts, a brand-new FIRST Robotics Competition (FRC) team driven by curiosity, grit, and a mission to make STEM accessible for every student in our community.
                As a rookie team, we're starting from scratch—no robot parts, no tools, and no legacy infrastructure. But what we do have is passion, big ideas, and a team of high schoolers ready to take on the world.
                <br/>
                <br/>
            ...
            <Button buttonStyle={"btn--black"} buttonSize={"btn--medium"} linkTo={"https://forms.gle/uuZscsTApGWR8Bm5A"}>
                Become a Sponsor
            </Button>
        </div>
    </div>
